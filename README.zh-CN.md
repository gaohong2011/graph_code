...
该命令通过 `build_agent().get_graph().draw_mermaid()` 写入 `docs/assets/stategraph-topology.mmd`，并通过 `draw_mermaid_png()` 写入 `docs/assets/stategraph-topology.png`。
...
- [StateGraph 结构](docs/zh-CN/stategraph-structure.md)
