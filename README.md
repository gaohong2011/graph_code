...
This writes `docs/assets/stategraph-topology.mmd` via `build_agent().get_graph().draw_mermaid()` and `docs/assets/stategraph-topology.png` via `draw_mermaid_png()`.
...
- [StateGraph structure](docs/en/stategraph-structure.md)
